    ...
    <div className='p-4 border-t border-slate-700/50'>
      ...
      <form onSubmit={handleSendMessage} className='max-w-3xl mx-auto flex space-x-4'>
        <input type='text'
          ...
          className='flex-1 bg-slate-800/50 border border-slate-700/50 rounded-lg py-2 px-4 text-white placeholder:text-slate-400 focus:outline-none focus:border-cyan-500'
